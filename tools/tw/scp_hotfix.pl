...
$ssh1->system("cd /www/doc/1/ios/HotfixConfig/ && wget 119.15.139.6/1/ios/HotfixConfig/HotfixConfig_$num.unity3d");
$ssh1->system("cd /www/doc/1/android/HotfixConfig/ && wget 119.15.139.6/1/android/HotfixConfig/HotfixConfig_$num.unity3d");
$ssh2->system("cd /www/doc/1/ios/HotfixConfig/ && wget 119.15.139.6/1/ios/HotfixConfig/HotfixConfig_$num.unity3d");
$ssh2->system("cd /www/doc/1/android/HotfixConfig/ && wget 119.15.139.6/1/android/HotfixConfig/HotfixConfig_$num.unity3d");			
